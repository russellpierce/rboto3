---
title: "Getting Started with 'rboto3'"
author: "Russell S. Pierce"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Getting Started with 'rboto3'}
...
s3$buckets$page_size(Inf)
lapply(iter_next(s3$buckets$pages()), function(bucket) {bucket$name})
```
